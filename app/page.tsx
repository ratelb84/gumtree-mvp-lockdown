...
export default function MVPLockdownPage() {
  ...
  const DEFAULT_FEATURES: Feature[] = [
    ...
    {
      id: 'mvp-1',
      title: 'Post Listing with Photos',
      description: 'Title, description, price, category, location, up to 6 photos, condition selector',
      person: 'don',
      column: 'mvp',
    ...
    {
      id: 'mvp-2',
      title: 'Edit/Delete/Pause Listings',
      description: 'Owner can modify or remove listings anytime',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      id: 'mvp-3',
      title: 'Browse Listings Grid',
      description: 'Category browsing, pagination, responsive layout, grid view',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Gallery, seller info, delivery options, Buy Now button, ratings',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Cars, Property, Jobs, Electronics, Home, Services, Furniture, Fashion, Pets, Sports',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    // SEARCH & DISCOVERY
    {
      ...
      description: 'Search across title + description, instant results',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Category, location (province/city), price range, condition',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      id: 'mvp-8',
      title: 'Sort & Browse',
      description: 'Sort by newest, price (asc/desc), relevance',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Heart icon, saved items page, wishlist notifications',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    // ACCOUNT MANAGEMENT
    {
      ...
      description: 'Email signup, login, password reset, remember me',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Profile creation, business info, bank details for payouts, verification',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Order history, saved items, active purchases, account settings',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Star ratings, review text, transaction history visibility',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    // CHECKOUT & PAYMENTS
    {
      ...
      description: 'One-click purchase, delivery selection, payment gateway',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Payfast/Peach integration, card payments in ZAR, split payments API',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      id: 'mvp-16',
      title: 'Escrow System',
      description: 'Secure payment hold until buyer confirms receipt, auto-release timer (7 days)',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    // DELIVERY & LOGISTICS
    {
      ...
      description: 'Pargo, Paxi, The Courier Guy - automated label generation',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Auto-calculate based on weight/size and destination, display at checkout',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Track status: Paid → Shipped → Delivered → Complete, courier links',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Allow face-to-face meetups, in-person payment, address sharing',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    // MESSAGING & SUPPORT
    {
      ...
      description: 'In-app chat for pre-purchase questions, real-time notifications',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Push/email notifications for new messages, badge counters',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    // SELLER TOOLS
    {
      id: 'mvp-23',
      title: 'Seller Wallet',
      description: 'Track earnings from completed sales, balance display, transaction history',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      id: 'mvp-24',
      title: 'EFT Payouts',
      description: 'Request payout to linked bank account, settlement within 3-5 business days',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Zero seller fees, 3-5% buyer protection fee, optional boost/promotion fees',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    // BUYER PROTECTION
    {
      ...
      description: 'All purchases covered - item not as described = refund',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Buyer raises issue → admin reviews → refund or release funds',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Buyer confirms delivery, triggers seller payout, auto-release timer',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    ...
    {
      id: 'mvp-29',
      title: '"Make an Offer" Feature',
      description: 'Buyers can negotiate price, sellers counter-offer, drives engagement',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    // CORE INFRASTRUCTURE
    {
      ...
      description: 'Responsive layout, optimized for mobile (~70% traffic), touch-friendly',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Next.js 15, PostgreSQL, Prisma, Vercel deployment, CI/CD',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'Users, listings, orders, wallets, messages, disputes, ratings',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'S3/R2 upload, auto-resize, WebP conversion, CDN delivery',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
    {
      ...
      description: 'User management, dispute resolution, fee configuration',
      person: 'don',
      column: 'mvp',
      timestamp: Date.now() - 3600000,
    },
